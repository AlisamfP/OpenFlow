...
export const Card = ({ isFav, text, icon }: CardProps) => {
    return (
            ...
            <CardHeader
                action={
                    <IconButton
                        ...
                        className={`!absolute top-0 right-0 rounded-full ${isFav ? "text-pink-300" : "text-background"} hover:text-pink-400`}
                    >
                        <PiHeart/>
                    </IconButton>
        ...
        // <CardMUI className="bg-card-back min-w-72 w-full lg:w-2/6 h-52 border-1 border-s-text grid grid-cols-[1fr_min-content] rounded-b-sm justify-items-start items-baseline p-2 cursor-pointer gap-4" >
        //     <CardMUI.Header className="col-start-2 col-end-3 justify-end bg-background relative cursor-pointer" >
        //         <IconButton
        //             size="lg"
        //             variant="ghost"
        ...
        //         </IconButton>
        //     </CardMUI.Header>
        //     <CardMUI.Body className="grid grid-cols-[minmax(max-content,_100px)_1fr] items-center w-full grid-row-[100px]">
        //         {icon &&
