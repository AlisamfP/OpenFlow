...
function App() {
    const [selectedCategory, setSelectedCategory] = useState<'general' | 'feelings' | 'custom' | 'favorites'>('general')

    const handleCategoryChange = (category: 'general' | 'feelings' | 'custom' | 'favorites') => {
